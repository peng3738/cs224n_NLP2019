...
class DummyVocab():
    def __init__(self):
        self.char2id = json.load(open('E:/NLP2019/Solution/a5_public/sanity_check_en_es_data/char_vocab_sanity_check.json', 'r'))
...
def question_1e_sanity_check():
    ...
    tgt_ind_gold = pickle.load(open('E:/NLP2019/Solution/a5_public/sanity_check_en_es_data/1e_tgt.pkl', 'rb'))
...
def question_1f_sanity_check():
    ...
    gold_padded_sentences = torch.load('E:/NLP2019/Solution/a5_public/sanity_check_en_es_data/gold_padded_sentences.pkl')
...
def main():
    ...
    vocab = Vocab.load('E:/NLP2019/Solution/a5_public/sanity_check_en_es_data/vocab_sanity_check.json')
